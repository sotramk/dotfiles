...
alias as="/home/sot/.local/bin/allservers"
#alias bakup='sudo rsync -avP --delete --exclude "VirtualBox VMs" /run/media/sot/DATA /run/media/sot/72bb57db-4b5c-4c22-85d1-ca33efee06f5'
alias bakup='sudo rsync -avP --delete --exclude "VirtualBox VMs" /run/media/sot/DATA/ /run/media/sot/72bb57db-4b5c-4c22-85d1-ca33efee06f5/Backup'
...
alias keyss='sudo pacman -Sy gnupg archlinux-keyring manjaro-keyring && sudo pacman-key --init && sudo pacman-key --populate archlinux manjaro && sudo pacman-key --refresh-keys'
alias lc='/home/sot/.local/bin/loss_calc.py'
...
alias mkx='chmod u+x *'
alias mp='mousepad'
alias netck='cat /var/log/pacman.log | grep -i "ed linux\|mware\|twork\|dkms ins\|a-nm\|nm-c\|ufw\|dhc\|wpa" | grep -v "head\|nvidia"  | tail -n 30'
alias mvp='mpv --fs "$(xclip -o)"'
alias v='mpv'
...
alias pd='.local/bin/priceDiff.py'
...
alias removeflash='rm -R  ~/.macromedia/Flash_Player/; removepepper;
sudo pacman -Suu'
...
alias tcv='sudo timeshift --create --verbose'
#alias tmuxns='tmux new -s home -n home'
alias tmuxns='tmux_ns.sh'
#alias tmuxq='tmux kill-ses -t'
